      ...
      <main className="container mx-auto px-4 md:px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
            This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Xalt Analytics. This policy is not applicable to any information collected offline or via channels other than this website.            </p>
            {/* <ul className="list-disc ml-6 mb-4 space-y-2">
            ...
            <h4 className="text-2xl font-semibold mt-8 mb-4">Consent</h4>
            <p>
            ...
            <h4 className="text-2xl font-semibold mt-8 mb-4">Information we collect</h4>
            <p>
            ...
            <h4 className="font-semibold mt-8 mb-4">Log Files</h4>
            <p>
            ...
            You may consult this list to find the Privacy Policy for each of the advertising partners of Xalt Analytics            </p>
            ...
            <p>Note that Xalt Analytics has no access to or control over these cookies that are used by third-party advertisers.</p>

            <h4 className="text-2xl font-semibold mt-8 mb-4">Third Party Privacy Policies</h4>
            ...
            <h4 className="text-2xl font-semibold mt-8 mb-4">Children's Information </h4>

<p>
Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.
</p>

<p>Xalt Analytics does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>



<h4 className="text-2xl font-semibold mt-8 mb-4">Changes to This Privacy Policy </h4>
